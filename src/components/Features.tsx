      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="max-w-3xl mx-auto text-lg text-gray-600 dark:text-gray-300">
            大垣市民病院集中治療科は、西濃医療圏における重症患者診療の中核として、最新の医療設備と専門知識を駆使した高度な集中治療を提供します。
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <FeatureCard
            ...
            title="最先端の医療設備"
            description="最新のICU・HCU施設を備え、ECMO、CHDF等の高度な生命維持管理を行っています。モニタリング技術も充実し、重症患者への迅速かつ的確な診断と治療を可能にします。"
            delay={100}
          />
          ...
          <FeatureCard
            ...
            title="オープンICUポリシー"
            description="広く門戸を開き、あらゆる診療科と連携して重症患者を受け入れます。各診療科の専門性と集中治療の専門性を融合させた最適な医療を提供します。"
            delay={400}
          />
